...
This is a sample template for book_boutique - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name book_boutique --tail
```
...
```bash
aws cloudformation delete-stack --stack-name book_boutique
```
